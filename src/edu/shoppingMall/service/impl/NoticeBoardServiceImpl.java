...
public class NoticeBoardServiceImpl implements NoticeBoardService {
    ...
    public static NoticeDAO noticedao = NoticeDAOImpl.getInstance();
     ...
     */
    @Override
	public List<NoticeBoardDTO> noticeBoardSelectAll(int pageNo, int pageSize) throws SQLException {
    	int startIndex = (pageNo - 1) * pageSize +1;
        int endIndex =  pageNo * pageSize;   			

    	List<NoticeBoardDTO> list = noticedao.noticeBoardSelectAll(startIndex,endIndex);
		return list;
