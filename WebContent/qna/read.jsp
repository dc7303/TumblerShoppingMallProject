...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    ...
    <tr>
        ...
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>	${dto.qnaBoardSubject}</b></span>
        </td>
    </tr>
    <tr>
        <td width="100" height="20" >
        ...
        <td width="300" height="20">
        	<span style="font-size:9pt;"><b>${dto.qnaBoardUserId}</b></span>
        </td>
     
    </tr>
    <tr>
        <td width="100" height="20">
            <p align="right"><b><span style="font-size:9pt;">등록일자</span></b></p>
        </td>
        <td width="450" height="20" colspan="3">
        	<span style="font-size:9pt;"><b>${dto.qnaBoardDate}</b></span>
        </td>
    </tr>
    <tr>
        ...
        <span style="font-size:9pt;"><b><pre>${dto.qnaBoardContent}</pre></b></span></td>
    </tr>
    <!--  
    <tr>
    <td width="100" height="20">
    ...
    -->
     <form name="requestForm" method=post action="qna">
    <tr>
